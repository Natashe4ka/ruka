...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("r_t");
...
public:
  ...
  void run()
  {
    ...
    arm_ = std::make_shared<moveit::planning_interface::PlanningComponent>("ruka", moveit_cpp_);
    ...
    auto trigger_callback = [this](const std_msgs::msg::Empty::SharedPtr msg) -> void
    {
      ...
      arm_->setGoal(goal_pose, "link_06");
    ...
    last_pose_.header.frame_id = "base_link";
  }
